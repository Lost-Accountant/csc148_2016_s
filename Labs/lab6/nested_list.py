...
def max_length(obj):
    ...
    if not isinstance(obj, list):
        ...
        #return max([len([max_length(x) for x in l]) if isinstance(l, list) else len(obj) for l in obj ])
...
def list_over(obj, n):
    ...
    # general case, iterable obj with unknown elements
