...
def time_sort(list_, sorted_list, which_sort):
    ...
    :type list_: list
    :param sorted_list: list to compare result to
    :type sorted_list: list
    :param which_sort: sorting algorithm
    :type which_sort: (list)->None
    """
...
def generate_data(n, sorted_=False, reversed_=False):
    ...
    :param n: number of ints in the list to be returned
    :type n: int
    :param bool sorted_: indicates whether or not to sort
    :type sorted_: bool
    :param reversed_: indicates whether or not to reverse
    :type reversed_: bool
    :rtype: list[int]
    """
...
def profile_comparisons(n):
    ...
    :param n: size of list to run algorithms on.
    :type n: int
    :rtype: None
    """
...
if __name__ == "__main__":
    ...
    for algo_ in [selection_sort, insertion_sort_1, insertion_sort_2,
                  bubblesort_1, bubblesort_2,
                  mergesort_1, mergesort_2,
                  quicksort_1, quicksort_2]:
        for i in range(1, 7):
            L = generate_data(i * 400)
