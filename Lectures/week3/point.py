class Point:
    ...
    def distance(self, other):
        """
        Calculate the distance between point self and point the other

        :return: square root of detla_x^2 + delta_y^2
        :rtype: float
        """

        return Point(abs(self.x - other.x), abs(self.y - other.y)).distance_to_origin()
...
if __name__ == "__main__":
    ...
    y  = Point(1,2)
    print("distance between 2 points", x.distance(y))
